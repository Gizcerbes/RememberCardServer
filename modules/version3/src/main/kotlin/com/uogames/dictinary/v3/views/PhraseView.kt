...
import com.uogames.dictinary.v3.db.entity.PhraseViewEntity
...
data class PhraseView(
    ...
    companion object : ViewMapper<PhraseEntity, PhraseView>{
        ...
        fun toView(viewEntity: PhraseViewEntity) = PhraseView(
            globalId = viewEntity.id.value,
            globalOwner = UserView.fromEntity(viewEntity.globalOwner),
            phrase = viewEntity.phrase,
            definition = viewEntity.definition,
            lang = viewEntity.lang,
            country = viewEntity.country,
            pronounce = viewEntity.pronounce?.let { PronunciationView.fromEntity(it) },
            image = viewEntity.image?.let { ImageView.fromEntity(it) },
