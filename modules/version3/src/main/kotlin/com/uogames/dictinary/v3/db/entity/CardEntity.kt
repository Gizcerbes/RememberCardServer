...
object CardTable : UUIDTable(name = "card_table", columnName = "global_id") {
...
class CardViewEntity(id: EntityID<UUID>) : UUIDEntity(id) {
    companion object : UUIDEntityClass<CardViewEntity>(CardTable)

    var globalOwner by UserEntity referencedOn CardTable.globalOwner
    var idPhrase by PhraseViewEntity referencedOn  CardTable.idPhrase
    var idTranslate by PhraseViewEntity referencedOn  CardTable.idTranslate
    var idImage by ImageEntity optionalReferencedOn  CardTable.idImage
    var reason by CardTable.reason
    var timeChange by CardTable.timeChange
    var like by CardTable.like
    var dislike by CardTable.dislike
