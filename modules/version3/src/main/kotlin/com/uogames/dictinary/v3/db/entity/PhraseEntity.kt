...
object PhraseTable : UUIDTable(name = "phrase_table", columnName = "global_id") {
...
class PhraseEntity(id: EntityID<UUID>) : UUIDEntity(id) {
    ...
    var length by PhraseTable.length
    ...
    fun update(phrase: Phrase) {
        ...
        length = phrase.phrase.length.toShort()
    }

}

class PhraseViewEntity(id: EntityID<UUID>) : UUIDEntity(id) {
    companion object : UUIDEntityClass<PhraseViewEntity>(PhraseTable)

    var globalOwner by UserEntity referencedOn PhraseTable.globalOwner
    var phrase by PhraseTable.phrase
    var definition by PhraseTable.definition
    var lang by PhraseTable.lang
    var country by PhraseTable.country
    var pronounce by PronunciationEntity optionalReferencedOn  PhraseTable.idPronounce
    var image by ImageEntity optionalReferencedOn  PhraseTable.idImage
    var timeChange by PhraseTable.timeChange
    var like by PhraseTable.like
    var dislike by PhraseTable.dislike
    var ban by PhraseTable.ban
